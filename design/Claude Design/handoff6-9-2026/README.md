...
> 🛑 **THIS README IS v1 (D43). Read `CHANGELOG-v2-READ-FIRST.md` FIRST** — it captures everything
> changed since (your audit applied + D44–D48): the contributor reframe (555 / personal coverage),
> invisible placeholders, the full Settings panes, Events & Holidays, and Spread the word being
> deferred. Where the two disagree, the changelog and `DESIGN-DECISIONS-LOG.md` (D36–D48) win.
