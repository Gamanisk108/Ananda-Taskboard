...
// Web artboard: pass pre-built frame HTML. Default width is a true desktop
// resolution (1440) so dense surfaces — esp. the Weekly calendar's 7 columns
// and the top bar — get the same breathing room as the real app.
const Web = ({ id, label, html, theme, w = 1440, h = 720 }) =>
