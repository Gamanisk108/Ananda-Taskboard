...
### D43 · All-done icon = line-art heart-hands · 2026-06-09
- The Improve-translations **all-done** screen uses the **heart-hands line-art icon** (hands
  joining to form a heart; house stroke style, 54px, accent ink), replacing the lotus. User
  initially said "emoji", then clarified **line-art icon** — so **NO emoji-allowlist change; D34
  stands unchanged** (project-picker emoji remain the only exception).
