...
Every rule is enforced server-side. These run in legacy (org=None) mode — the
org-aware engine paths are covered by the multi-tenancy suite; here we pin the
reduced-access logic itself."""
